...
### Αποτελέσματα
![Placeholder για το διάγραμμα αποτελεσμάτων RDD vs DataFrame](images/query1_results.png)

### Συμπεράσματα
- Το DataFrame API είναι συνήθως ταχύτερο λόγω του Catalyst Optimizer.
...
### Αποτελέσματα
![Placeholder για τα αποτελέσματα του Ερωτήματος 2](images/query2_results.png)
...
- Η αποθήκευση σε Parquet βελτιστοποιεί την ανάγνωση δεδομένων λόγω της αποδοτικής μορφής του.
...
### Αποτελέσματα
![Placeholder για τις στρατηγικές Join](images/query3_join_strategies.png)
...
1. 1 core / 2 GB memory
2. 2 cores / 4 GB memory
3. 4 cores / 8 GB memory
...
| VAN NUYS          | 0.028653154590629133 | 211457  |
| WILSHIRE          | 0.026312166557481587 | 198150  |
| SOUTHWEST         | 0.02157700118424315  | 186742  |
| OLYMPIC           | 0.017291621123313377 | 180463  |
| NORTH HOLLYWOOD   | 0.02611521422256773  | 171159  |
...
| VAN NUYS          | 0.02865315459062913  | 211457  |
| WILSHIRE          | 0.026312166557481583 | 198150  |
| SOUTHWEST         | 0.021577001184243143 | 186742  |
| OLYMPIC           | 0.01729162112331338  | 180463  |
